...
export async function POST(request: NextRequest) {
  try {
    ...
    // If targeting an explicit project, require access to that project too.
    if (projectId) {
      const canAccessTargetProject = await userOwnsProject(userIP, projectId)
